...
beforeAll(async function (){
  try {
    ...
    inserted_user = await user.insertOne({
      username: 'Geraldine.Goldner22',
      password: 'YOS3U9RtlvRN5ah',
      email: 'Eleanora90@gmail.com',
      name: 'Bernadette Beahan',
      mobileNo: '1-283-399-1578 x949',
      role: 190,
      resetPasswordLink: {},
      loginRetryLimit: 183,
      loginReactiveTime: '2022-09-09T16:53:38.723Z',
      id: '6198d4ae34a9531074f6bab6'
    });
  }
  catch (err) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Reilly.Dibbert',
        'password':'nKheWiEP6EAIh21',
        'email':'Lavinia12@gmail.com',
        'name':'Kelly Pouros',
        'mobileNo':'1-844-648-0790',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    ...
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Lavinia12@gmail.com', });
